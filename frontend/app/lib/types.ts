...
export interface ConfiguracionGlobal {
  ...
  email?: string;
  direccion?: string;
  proyectos_titulo?: string;
  proyectos_intro?: string;
  biblioteca_titulo?: string;
  biblioteca_intro?: string;
  blog_titulo?: string;
  comparador_titulo?: string;
  comparador_intro?: string;
  contacto_titulo?: string;
  contacto_intro?: string;
  contacto_form_titulo?: string;
  contacto_form_texto?: string;
  contacto_preparado_titulo?: string;
  contacto_preparado_texto?: string;
  whatsapp?: string;
